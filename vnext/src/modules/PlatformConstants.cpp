...
//
// `install<Impl>()` is generated by the spec — it owns the
// registerModule call so impls don't have to know about the
// registry singleton.
[[maybe_unused]] static const int kRegisterPlatformConstants =
    codegen::NativePlatformConstantsLinuxSpec::install<PlatformConstantsModule>();
